Daily Confluence update for the OI30 space, 2026-09-03 (Singapore time).
...
**4 pages changed** — 1 added, 3 updated, 0 removed.
...
- [Cost Bar split](https://bainco.atlassian.net/wiki/spaces/OI30/pages/19792560136) — **page is empty** (no text, no diagram)

## Added

- [Cost Bar split](https://bainco.atlassian.net/wiki/spaces/OI30/pages/19792560136)
...
[Sync commit](https://github.com/deanwang-bain/OC-TL/commit/190af003f0ec50f23b05a99d7acdfa95d2294081) · [Workflow run](https://github.com/deanwang-bain/OC-TL/actions/runs/33697835372)
