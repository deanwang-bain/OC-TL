Daily Confluence update for the OI30 space, 2026-09-22 (Singapore time).
...
**4 pages changed** — 4 added, 0 updated, 0 removed.

## Third-party dependencies to rule on

- **web search** named in [Future Scope-- With ai search.](https://bainco.atlassian.net/wiki/spaces/OI30/pages/19849412714)
- **web search** named in [Present working-- Technical details](https://bainco.atlassian.net/wiki/spaces/OI30/pages/19849609338)
- **web search** named in [TO BE DELETE.](https://bainco.atlassian.net/wiki/spaces/OI30/pages/19849445516)
...
**4 new page(s) not yet referenced in `context/`** — unread:
...
**Page counts in `CLAUDE.md` are stale** — recorded 79 pages (62 text, 8 attachment, 9 empty); mirror now holds 83 (66, 8, 9).

**4 page(s) changed since the standing agenda was last reviewed (2026-09-21)** — the agenda may be asking for things already settled:
...
[Sync commit](https://github.com/deanwang-bain/OC-TL/commit/9b96d9bdfde8ec9eaf81266b235be12dba6b159b) · [Workflow run](https://github.com/deanwang-bain/OC-TL/actions/runs/35673085760)
