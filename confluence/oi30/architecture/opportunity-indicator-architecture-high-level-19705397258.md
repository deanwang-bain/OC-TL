...
Endpoints & Interfaces Design

Security Design (Processing, AI and Data)

NFR (Non-Functional) Design Choices

Observability, Logging, Notification & Monitoring Design
